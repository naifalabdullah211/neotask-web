  ...
  Widget build(BuildContext context) {
    ...
    if (_form == null) {
      return const Scaffold(
        body: Center(child: Text('هذا النموذج غير متاح أو تم إيقافه')),
      );
    }
    if (_submitted) {
      return const Scaffold(
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          'assets/images/neotask_brand_header.png',
                          height: 42,
                        ),
  ...
  Widget _buildField(CustomFormField field) {
    ...
    if (field.type == CustomFieldType.choice) {
      child = NeoSelectionField<String>(
        ...
        value: _answers[field.fieldId] as String?,
      ...
      child = TextFormField(
        ...
        decoration: InputDecoration(
          labelText: '${field.label}$requiredLabel',
          hintText: field.type == CustomFieldType.date ? 'YYYY-MM-DD' : null,
        ),
        validator: (value) {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('تعذّر إرسال الرد. حاول مرة أخرى')),
        );
      }
    }
  }
