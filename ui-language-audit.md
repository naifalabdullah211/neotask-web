...
|---:|---|---|---|
| 12 | `lib/screens/manager/manager_ideas_screen.dart` | Arabic UI literals may bypass LocalizedText, 1 untranslated non-Text properties, legacy ListView/ListTile presentation, legacy empty state | hintText: اكتب طلبك لمساعد المدير... |
...
| 6 | `lib/screens/manager/past_polls_screen.dart` | legacy ListView/ListTile presentation, legacy empty state, small legacy screen shell |  |
| 6 | `lib/screens/shared/contacts_screen.dart` | legacy ListView/ListTile presentation, legacy empty state, small legacy screen shell |  |
| 6 | `lib/screens/shared/favorites_screen.dart` | legacy ListView/ListTile presentation, legacy empty state, small legacy screen shell |  |
| 6 | `lib/screens/shared/search_screen.dart` | legacy ListView/ListTile presentation, legacy empty state, small legacy screen shell |  |
...
| 3 | `lib/screens/employee/employee_home_screen.dart` | 1 untranslated non-Text properties, small legacy screen shell | message: الملف الشخصي والقائمة |
